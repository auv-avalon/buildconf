...
Autoproj.change_option('GITORIOUS_PUSH_ROOT', 'git@192.168.128.10:gitserver')
Autoproj.change_option('SPACEGIT_ROOT', 'git://192.168.128.10')
Autoproj.change_option('SPACEGIT_PUSH_ROOT', 'git@192.168.128.10:gitserver')
Autoproj.change_option('GITHUB_ROOT', 'git://192.168.128.10')
Autoproj.change_option('GITHUB_PUSH_ROOT', 'git@192.168.128.10:gitserver')
